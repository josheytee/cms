...
<div class="wthree_agile_admin_info">
    ...
    <div class="w3_agileits_top_nav">
        <ul id="gn-menu" class="gn-menu-main">
                ...
                <nav class="gn-menu-wrapper">
                    <div class="gn-scroller scrollbar1">
                        <ul class="gn-menu agile_menu_drop">
                            ...
                            <li><a href="charts.html"> <i class="fa fa-line-chart" aria-hidden="true"></i> Charts</a>
                            </li>
                            ...
                            <li class="page">
                                ...
                                <ul class="gn-submenu">
                                    ...
                                    <li class="mini_list_w3"><a href="signup.html"> <i class="fa fa-caret-right"
                                                                                       aria-hidden="true"></i> Sign
                                            Up</a></li>
                                    <li class="mini_list_agile error"><a href="404.html"> <i class="fa fa-caret-right"
                                                                                             aria-hidden="true"></i>
                                            Error 404 </a></li>

                                    <li class="mini_list_w3_line"><a href="calendar.html"> <i class="fa fa-caret-right"
                                                                                              aria-hidden="true"></i>
                                            Calendar</a></li>
                                </ul>
                            </li>
            ...
            <!-- //nav_agile_w3l -->
            <li class="second logo"><h1><a href="main-page.html"><i class="fa fa-graduation-cap" aria-hidden="true"></i>Esteem
                    </a></h1></li>
                    ...
                    <li class="dropdown profile_details_drop">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            <div class="profile_img">
                                <span class="prfil-img"><img src="{{asset('images/').'/'.Auth::user()->image}}" alt="" style="width: 45px;height: 45px"> </span>
                            </div>
                        </a>
    ...
    <div class="inner_content">
        ...
        <div class="w3l_agileits_breadcrumbs">
            <div class="w3l_agileits_breadcrumbs_inner">
                ...
                {{--<li>FaQs</li>--}}
                {{--</ul>--}}
                <p>Welcome <strong>{{strtoupper(Auth::user()->fname) }} </strong></p>
            </div>
        </div>
        <!-- //breadcrumbs -->
        ...
        <!-- /social_media-->
            <div class="social_media_w3ls">
                ...
                <div class="col-md-3 socail_grid_agile twitter">
                    <ul class="icon_w3_info">
                        <li><a href="#" class="wthree_facebook"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                        </li>
                        <li>Twitter</li>
                    </ul>
                    <ul class="icon_w3_social">
                ...
                <div class="col-md-3 socail_grid_agile dribble">
                    ...
                    <ul class="icon_w3_info">
                        <li><a href="#" class="wthree_facebook"><i class="fa fa-dribbble" aria-hidden="true"></i></a>
                        </li>
                        <li>Dribbble</li>
                    </ul>
                    <ul class="icon_w3_social">
...
<div class="copyrights">
    <p>© <?php echo date('Y'); ?> Esteem. All Rights Reserved | Design by <a href="http://w3layouts.com/"
...
<script src="{{ asset('admin/js/prettymaps.js')}}"></script>
<script>
